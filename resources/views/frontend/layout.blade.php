...
@php
  ...
  $cartItemData = getAddToCartTotalItem();
  $cartTotalItems = count($cartItemData);
  $totalPrice = 0;
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="#" id="cartBox">
                  ...
                  <span class="aa-cart-notify">{{$cartTotalItems}}</span>
                </a>
                ...
                @if( $cartTotalItems != 0)
                  ...
                  <ul>
                    @foreach($cartItemData as $cart_data)
                    @php
                      $totalPrice = $totalPrice + ($cart_data->qty * $cart_data->price);
                    @endphp
                    
                    <li>
                      <a class="aa-cartbox-img" href="{{ url('product/'.$cart_data->slug) }}"><img src="{{asset('storage/media/'.$cart_data->image)}}" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="{{ url('product/'.$cart_data->slug) }}">{{ $cart_data->name }}</a></h4>
                        <p>{{ ($cart_data->qty)}} x Rs {{ ($cart_data->price)}}</p>
                      </div>
      ...
      <div class="modal-content">                      
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          ...
          <form class="aa-login-form" id="frmLogin">
            ...
            <input type="email" placeholder="email" name="login_email" required value="{{ $login_email }}">
            <label for="">Password<span>*</span></label>
            <input type="password" placeholder="Password" name="login_password" required value="{{ $login_pwd }}">
            <button class="aa-browse-btn" type="submit" id="btnLogin">Login</button>
            <label for="rememberme" class="rememberme">
            <input type="checkbox" id="rememberme" name="rememberme" {{ $is_remembered }} > Remember me </label>
          ...
          <form class="aa-login-form" id="frmForgot">
            ...
            <div><p class="aa-lost-password"><a href="javascript:void(0)" onclick="back_to_login()">Back To Login</a></p></div>
