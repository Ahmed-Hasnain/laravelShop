                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('tax.manage_tax_process') }}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="tax_value" name="tax_value" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $tax_value }}" >
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="tax_desc" name="tax_desc" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $tax_desc }}" >
                                            </div>
