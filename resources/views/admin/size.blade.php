                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                    ...
                                    <a href="{{ url('admin/customer/manage_customer/') }}/{{ $customer_child->id }}"><button type="button" class="    btn btn-success btn-sm">Edit</button>
                                    </a> 
                                ...
                                @endif
                                    ...
                                    <a href="{{ url('admin/customer/delete') }}/{{ $customer_child->id }}"><button type="button" class="    btn btn-danger btn-sm">Delete</button>
                                    </a>
