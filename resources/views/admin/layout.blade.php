                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="@yield('size_selected')">
                            <a  href="{{ url('admin/size/') }}">
                                <i class="fas fa-heart"></i>Size</a>

                        </li>
                        <li class="@yield('color_selected')">
                            <a  href="{{ url('admin/color/') }}">
                                <i class="fa fa-tint"></i>color</a>

                        </li>
                         <li class="@yield('brand_selected')">
                            <a  href="{{ url('admin/brand/') }}">
                                <i class="fa fa-tint"></i>Brand</a>
                        ...
                        <li class="@yield('home_banner_selected')">
                            <a  href="{{ url('admin/home_banner') }}">
                                <i class="fa fa-user"></i>Home Banner</a>
                        ...
                        <li class="@yield('product_review_selected')">
                            <a  href="{{ url('admin/product_reviews') }}">
                                <i class="fas fa-heart"></i>Product Reviews</a>
